...
public class p12_db2 extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<head><link rel='stylesheet' href'style.css' type='text/css'>");
            // Extract data from result set ws3
            while (rs.next()) {
                // Retrieve by column name
                String name=rs.getString("name");
                Integer gp = rs.getInt("games");
                Integer goals = rs.getInt("goals");
                Integer assist = rs.getInt("assist");
                Integer fouls = rs.getInt("foul");
                // Display values
                out.println("<p> <b>Player ID :</b> " + pid + "<br>");
                out.println("<b>Name : </b>" + name + "<br><hr style='border: 1px solid'><br>");
                out.println("<b>Games palyed : </b>" + gp + "<br>");
                out.println("<b>Goals : </b>" + goals + "<br>");
                out.println("<b>Assists : </b>" + assist + "<br>");
                out.println("<b>Fouls : </b>" +fouls + "<br></p>");
            }
